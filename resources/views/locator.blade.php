        ...
        <div class="row">
            ...
            <div class="col-md-6 float-end">
                ...
                <table class="table table-borderless table-condensed">
                    <tbody>
                        <tr>
                            <td style="width: 20%"><i class="fa fa-whatsapp" aria-hidden="true"></i>&nbsp;Mobile</td>
                            <td style="width: 2.66%">:</td>
                            <td><a href="http://wa.me/8849004643" target="_blank"
                                    style="color: black;">+91-1234567891</a>
                            </td>
                        </tr>
                        <tr>
                            <td><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;Email</td>
                            <td>:</td>
                            <td><a href="mailto:info@learnvern.com" style="color: black;">info@test.com</a></td>
                        </tr>
                        <tr>
                            <td><i class="fa fa-map-marker" aria-hidden="true"></i>&nbsp;Address</td>
                            <td>:</td>
                            <td>E-Commerce Store, <br>
                                1001 ABC Complex, <br>
